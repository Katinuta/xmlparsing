...
public class VegetablesSAXBuilderTest {
    private VegetablesSAXBuilder builder;
    public Set<Vegetable> actualSalad;
    public Set<Vegetable> expectedSalad;
    ...
    @Test
    public void parserSAXReturnsCorrectDataTest() {
